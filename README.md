...
```python
focus = {
    "current": ["Transformers from scratch", "Distributed training (DDP)",
                "Model quantization", "Attention / KV-cache efficiency"],
    "applied_at_work": ["LangGraph agent pipelines", "Hybrid vector search (Qdrant)",
                         "FastAPI / Docker / AWS services"],
    "hardware": ["ESP32 / MCU firmware", "On-device INT8 inference (TFLite)",
                 "DSP for biosignal processing"],
}
```
...
<img src="https://img.shields.io/github/followers/memehdi14?label=Followers&style=for-the-badge&color=22c55e&logo=github&logoColor=white" alt="Followers"/>
<img src="https://img.shields.io/github/stars/memehdi14?label=Stars&style=for-the-badge&color=22c55e&logo=github&logoColor=white" alt="Stars"/>

<br/>

<!-- snake animation: renders once the GitHub Action below has run successfully in memehdi14/memehdi14 -->
<img src="https://raw.githubusercontent.com/memehdi14/memehdi14/output/github-contribution-grid-snake.svg" alt="Snake animation" width="100%"/>
...
<!--
  ...
  - shields.io: followers/stars badges — pulls live GitHub API data
    through Shields' own CDN rather than a small community Vercel
    deployment, which is far more reliable than the trophy generators
    (every github-profile-trophy instance/mirror tried was unreliable,
    so dropped that approach entirely)
  - the snake animation is NOT a live third-party service — it's
    generated by a GitHub Action running in your own repo (workflow
    below). It will only render once that Action has been added to
    the repo, given write permissions, and run at least once.
-->
...
<a href="https://www.linkedin.com/in/mohammad-mehdi-namdar-042609327/"><img src="https://img.shields.io/badge/LinkedIn-Mohammad_Mehdi_Namdar-0077B5?style=for-the-badge" alt="LinkedIn"/></a>
